...
28: IFD-PATH=[IFD/Exif] ID=(0x927c) NAME=[MakerNote] TYPE=(7):[UNDEFINED] VALUE=[MakerNote<TYPE-ID=[28 00 01 00 03 00 31 00 00 00 74 05 00 00 02 00 03 00 04 00] LEN=(8152) SHA1=[d4154aa7df5474efe7ab38de2595919b9b4cc29f]>]
...
47: IFD-PATH=[IFD/Exif] ID=(0xa432) NAME=[LensSpecification] TYPE=(5):[RATIONAL] VALUE=[16/1...]
...
50: IFD-PATH=[IFD/GPSInfo] ID=(0x00) NAME=[GPSVersionID] TYPE=(1):[BYTE] VALUE=[02 03 00 00]
51: IFD-PATH=[IFD1] ID=(0x103) NAME=[Compression] TYPE=(3):[SHORT] VALUE=[6]
52: IFD-PATH=[IFD1] ID=(0x11a) NAME=[XResolution] TYPE=(5):[RATIONAL] VALUE=[72/1]
53: IFD-PATH=[IFD1] ID=(0x11b) NAME=[YResolution] TYPE=(5):[RATIONAL] VALUE=[72/1]
54: IFD-PATH=[IFD1] ID=(0x128) NAME=[ResolutionUnit] TYPE=(3):[SHORT] VALUE=[2]
57: IFD-PATH=[IFD/Exif/Iop] ID=(0x01) NAME=[InteroperabilityIndex] TYPE=(2):[ASCII] VALUE=[R98]
58: IFD-PATH=[IFD/Exif/Iop] ID=(0x02) NAME=[InteroperabilityVersion] TYPE=(7):[UNDEFINED] VALUE=[0100]
`
